        ...
        <div className="flex items-center justify-between h-16">
          ...
          {user && onLogout && (
             <div className="flex items-center space-x-4">
               <span className="text-slate-600 font-medium">Xin chào, <span className="font-bold">{user.name}</span></span>
               <button onClick={onLogout} className="font-medium text-slate-600 hover:text-rose-600 transition-colors">
                 Đăng xuất
               </button>
             </div>
          )}
